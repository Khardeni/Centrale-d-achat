package tn.esprit.spring.services.User.Mail;
...
public class EmailServiceImpl implements IUserEmailRepository {
    ...
    public void sendCodeByMail(UserMail mail) {
        ...
        simpleMailMessage.setFrom("jesser7elouni@gmail.com");
    ...
    public void sendVerificationEmaila(User user) {
        ...
        message.setText("Bonjour " + user.getUserFirstName() + ",\n\n" +
                ...
                "http://localhost:8099/activate?token=" + user.getVerificationToken());
    ...
    public void sendVerificationEmail(User user) throws MessagingException {
        ...
        String text = "<html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\"><head>\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 16px; line-height: 22.4px;\"><strong><span style=\"font-family: Montserrat, sans-serif; line-height: 22.4px; font-size: 16px;\">E-Spare</span></strong></span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 150%;\"><span style=\"font-family: Lato, sans-serif; font-size: 14px; line-height: 21px;\"><span style=\"font-size: 16px; line-height: 24px;\">&nbsp;Bonjour  <strong><span style=\"color: #e67e23; font-size: 16px; line-height: 24px;\"> <span style=\"font-size: 18px; line-height: 27px;\">"+user.getUserLastName()+"&nbsp;"+user.getUserFirstName()+",</span></span></strong></span></span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "        \n" +
                "  <div class=\"v-text-align\" style=\"color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;\">\n" +
                "    <p style=\"font-size: 12px; line-height: 140%;\"><strong>http://localhost:4200/verify/" + user.getVerificationToken()+"</strong></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
        ...
        helper.setSubject("Verificiation");
        helper.setFrom("jesser7elouni@gmail.com");
    ...
    public void sendEmail(String to, String subject) throws MessagingException {
        ...
        String text = "<html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\"><head>\n" +
               ...
               // "      <img align=\"center\" border=\"0\" src=\"images/image-5.png\" alt=\"\" title=\"\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 580px;\" width=\"580\">\n" +
                ...
                "        \n" +
                "  <div class=\"v-text-align\" style=\"color: #34495e; line-height: 150%; text-align: left; word-wrap: break-word;\">\n" +
                "    <p style=\"font-size: 14px; line-height: 150%;\"><span style=\"font-family: Lato, sans-serif; font-size: 14px; line-height: 21px;\"><span style=\"font-size: 16px; line-height: 24px;\">&nbsp;Bonjour,  <strong><span style=\"color: #e67e23; font-size: 16px; line-height: 24px;\"> <span style=\"font-size: 18px; line-height: 27px;\"></span></span></strong></span></span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
