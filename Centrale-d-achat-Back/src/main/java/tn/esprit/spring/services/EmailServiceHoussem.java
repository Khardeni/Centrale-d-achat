...
import tn.esprit.spring.DTO.ArticleCommandeDTO;
...
@Service
public class EmailServiceHoussem implements EmailSender {
    @Autowired
    ...
    public void send(CheckoutDTO checkoutDTO) {
        ...
        String text = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 16px; line-height: 22.4px;\"><strong><span style=\"font-family: Montserrat, sans-serif; line-height: 22.4px; font-size: 16px;\">E-Spare<br>Hi "+ checkoutDTO.getNom_prenom()+"</span></strong></span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                for(ArticleCommandeDTO acd : checkoutDTO.getArticleCommandeList()) {
                    text = text + "<div class=\"u-row-container\" style=\"padding: 0px;background-color: transparent\">\n" +
                            "  <div class=\"u-row\" style=\"Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #ffffff;\">\n" +
                            "    <div style=\"border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;\">\n" +
                            "      <!--[if (mso)|(IE)]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding: 0px;background-color: transparent;\" align=\"center\"><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"width:600px;\"><tr style=\"background-color: #ffffff;\"><![endif]-->\n" +
                            "      \n" +
                            ...
                            "        \n" +
                            "  <div class=\"v-text-align\" style=\"color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;\">\n" +
                            "    <p style=\"font-size: 14px; line-height: 140%;\"><strong>"+acd.getNomArticle()+"</strong></p>\n" +
                            "  </div>\n" +
                            "\n" +
                            "      </td>\n" +
                            "    </tr>\n" +
                            ...
                            "        \n" +
                            "  <div class=\"v-text-align\" style=\"color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;\">\n" +
                            "    <p style=\"font-size: 14px; line-height: 140%;\"><strong>"+acd.getPrixArticle()+"</strong></p>\n" +
                            "  </div>\n" +
                            "\n" +
                            "      </td>\n" +
                            "    </tr>\n" +
                            ...
                            "        \n" +
                            "  <div class=\"v-text-align\" style=\"color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;\">\n" +
                            "    <p style=\"font-size: 14px; line-height: 140%;\"><strong>"+acd.getQuantite()+"</strong></p>\n" +
                            "  </div>\n" +
                            "\n" +
                            "      </td>\n" +
                            "    </tr>\n" +
                            ...
                            "    <p style=\"font-size: 14px; line-height: 140%;\"><strong>"+acd.getQuantite()*acd.getPrixArticle()+"</strong></p>\n" +
                            "  </div>\n" +
                            "\n" +
                            "      </td>\n" +
                            "    </tr>\n" +
...
//                "          <img src=\"images/image-3.png\" alt=\"Twitter\" title=\"Twitter\" width=\"32\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important\">\n" +
        ...
        helper.setTo("houssem.hosni@esprit.tn");
